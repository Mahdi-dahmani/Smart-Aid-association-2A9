...
query.prepare("update SPONSOR set NOM_SPONSOR=:nom_sponsor , PRENOM_SPONSOR =:prenom_sponsor , EMAIL_SPONSOR =:email_sponsor , NUM_TEL_SPONSOR =:num_tel_sponsor , ADRESSE_SPONSOR=:adresse_sponsor ,DATE_DEBUT_SPONSOR=:date_debut_sponsor,MONTANT_SPONSOR=:montant_sponsor where IDENTIFIANT_SPONSOR=:IDD ");
